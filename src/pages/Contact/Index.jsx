...
export default function Contact() {
  ...
  return (
    <div className="isolate border-y-2 border-indigo-600 px-6 py-24 sm:py-32 lg:px-8 bg-indigo-900">
      <div
        aria-hidden="true"
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <div className="flex rounded-md bg-white outline-1 outline-gray-300 focus-within:outline-2 focus-within:outline-indigo-600">
          ...
          <Field className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className="transform rounded-full bg-white shadow-xs ring-1 ring-gray-900/5 transition duration-200 ease-in-out group-data-checked:translate-x-3.5"
                />
              </Switch>
            </div>
